...
public class ConnectionService {
   ...
   */
  public List<UserViewModel> getUserConnections(final User user) {
   ...
   */
  public Page<?> getPaginatedUserConnections(final Pageable pageable, final User user) {
   ...
   */
  @Transactional
  public Connection createConnectionBetweenTwoUsers(final User initializer, final String email) {
   ...
   * @return connection object
   */
  protected Connection createConnection(final User initializer, final User receiver) {
   ...
   */
  public Optional<ConnectionViewModel> getConnectionById(final Integer id) {
  ...
  public static ConnectionViewModel connectionToViewModel(final Connection connection) {
